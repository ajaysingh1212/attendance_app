...
Route::get('payrolls/download/{format}', [PayrollController::class, 'downloadPayrollPdf'])
...
Route::get('payrolls/download/{payrollId}', [PayrollController::class, 'downloadPayrollPdf'])
    ->name('payrolls.download');
