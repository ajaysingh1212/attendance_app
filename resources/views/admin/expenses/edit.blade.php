    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expenses.update", [$expense->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="user_id">{{ trans('cruds.expense.fields.user') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remark') ? 'is-invalid' : '' }}" type="text" name="remark" id="remark" value="{{ old('remark', $expense->remark) }}">
