    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reports.update", [$report->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales') ? 'is-invalid' : '' }}" type="number" name="sales" id="sales" value="{{ old('sales', $report->sales) }}" step="0.01" required>
                @if($errors->has('sales'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sales') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_of_sell') ? 'is-invalid' : '' }}" type="text" name="cost_of_sell" id="cost_of_sell" value="{{ old('cost_of_sell', $report->cost_of_sell) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('metrial_cost') ? 'is-invalid' : '' }}" type="text" name="metrial_cost" id="metrial_cost" value="{{ old('metrial_cost', $report->metrial_cost) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salaries') ? 'is-invalid' : '' }}" type="text" name="salaries" id="salaries" value="{{ old('salaries', $report->salaries) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tour_travel') ? 'is-invalid' : '' }}" type="text" name="tour_travel" id="tour_travel" value="{{ old('tour_travel', $report->tour_travel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_cost') ? 'is-invalid' : '' }}" type="text" name="other_cost" id="other_cost" value="{{ old('other_cost', $report->other_cost) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unpaid_amount') ? 'is-invalid' : '' }}" type="text" name="unpaid_amount" id="unpaid_amount" value="{{ old('unpaid_amount', $report->unpaid_amount) }}">
