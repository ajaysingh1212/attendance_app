...
<div class="card shadow-lg border-0">
    ...
    <div class="card-body table-responsive">
        ...
        <div class="mb-3 text-end">
            <h5 class="fw-bold">
                💰 Total Net Salary: <span id="totalNetSalary" class="text-success">₹0.00</span>
            </h5>
        </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title">💳 Part Payment History</h5>
...
function calculateTotalNetSalary() {
    ...
    $('#totalNetSalary').text('₹' + total.toLocaleString('en-IN', { minimumFractionDigits: 2 }));
}
